...
class Lambda:
    ...
    def execute_lambda(self, competitor_name):
...
class Scraper:
    ...
    def __init__(self):
        self.lambda_instances = self.create_lambda_instances()
    ...
    def execute_scraper_lambda(self, avoidable_ip_address_list=None, competitor_name=None):
        ...
        if recommended_ip_address_list:
            ...
            ip_address, competitor_name, execution_time = self.lambda_instances[ip_address].execute_lambda(competitor_name)
        else:
            ip_address = None
            execution_time = None
