...
class TestTranslator:
    def test_translator_sqs(self):
        ...
        message_0 = json.load(open('tests/test_data/mock_event_data_sqs.json', 'r'))[0]
        message_1 = json.load(open('tests/test_data/mock_event_data_sqs.json', 'r'))[1]
    ...
    def test_translator_sns(self):
        ...
        message = json.load(open('tests/test_data/mock_event_data_sns.json', 'r'))
